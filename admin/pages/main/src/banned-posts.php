                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php
                                        ...
                                        $obj=new Config;
                                        $sql=$obj->conn()->query("SELECT * FROM blog WHERE is_banned='1'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <ul class="list-inline m-0" style="float: right;margin: -4px;">
                                                ...
                                                <li class="list-inline-item">
                                                    <button  class="btn btn-secondary btn-sm rounded-0 unban waves-effect m-r-30" 
                                                        type="button" 
                                                        data-toggle="modal" 
                                                        data-target="#largeModal" 
                                                        title="Unban"  id="<?php echo $row['blog_id']; ?>"><i class="fa fa-undo"></i></button>
                                                </li>
                                                <!-- <li class="list-inline-item">
