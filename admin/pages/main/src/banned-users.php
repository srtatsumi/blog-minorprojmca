                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $obj=new Config;
                                            $sql=$obj->conn()->query("SELECT * FROM users WHERE is_banned='1'  ");
                                        ...
                                        <tr>
                                            ...
                                            <ul class="list-inline m-0" style="float: right;margin: -4px;">
                                                <!-- <li class="list-inline-item">
                                                    <button class="btn btn-primary btn-sm rounded-0 " type="button" data-toggle="tooltip" title="View"><i class="fa fa-eye"></i></button>
                                                </li> -->
                                                <!-- <li class="list-inline-item">
                                                    <button class="btn btn-success btn-sm rounded-0" type="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></button>
                                                </li> -->
                                                <li class="list-inline-item">
                                                    <button  class="btn btn-secondary btn-sm rounded-0 unban waves-effect" 
                                                        type="button" 
                                                        data-toggle="modal" 
                                                        data-target="#largeModal" 
                                                        title="Unban"  id="<?php echo $row['user_id']; ?>"><i class="fa fa-undo"></i>
                                                    </button>
                                                </li>
