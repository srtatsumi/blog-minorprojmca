                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $obj=new Config;
                                            $sql=$obj->conn()->query("SELECT * FROM blog WHERE is_published='1' and is_approved='1'");
                                        ...
                                        <tr>
                                            ...
                                            <ul class="list-inline m-0" style="float: right;margin: -4px;">
                                                ...
                                                <li class="list-inline-item">
                                                    <button 
                                                        class="btn btn-warning btn-sm rounded-0 ban waves-effect m-r-20" 
                                                        type="button" 
                                                        data-toggle="modal" 
                                                        data-target="#largeModal" 
                                                        title="Ban" 
                                                        id="<?php echo $row['blog_id']; ?>"><i class="fa fa-times"></i>
                                                    </button>
                                                </li>
                                                <li class="list-inline-item">
                                                    <button 
                                                        ...
                                                        data-target="#largeModal" 
                                                        title="Delete" 
                                                        id="<?php echo $row['blog_id']; ?>"><i class="fa fa-trash"></i>
                                                    </button>
                                                </li>
                                            </ul>
                                            </td>
