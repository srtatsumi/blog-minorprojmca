                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php
                                        ...
                                        $obj=new Config;
                                        $sql=$obj->conn()->query("SELECT * FROM blog WHERE is_published='1' AND (is_approved = '0' OR is_approved IS NULL) ");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                            <?php
                                                if($row['is_published']=='1' && $row['is_approved']!= '1'){
                                                    echo 'unapproved';
                                                }
                                            ?>
                                            ...
                                            <ul class="list-inline m-0" style="float: right;margin: -4px;">
                                                <li class="list-inline-item">
                                                   <button 
                                                        class="btn btn-primary btn-sm rounded-0 view waves-effect " 
                                                        type="button" 
                                                        data-toggle="modal" 
                                                ...
                                                <li class="list-inline-item">
                                                    <button 
                                                    class="btn btn-success btn-sm rounded-0 waves-effect approve" 
                                                    type="button" 
                                                    data-toggle="modal" 
                                                    data-target="#largeModal"
                                                    title="Approve"
                                                    id="<?php echo $row['blog_id']; ?>"><i class="fa fa-check"></i></button>
                                                </li>
                                                <li class="list-inline-item">
                                                    <button 
                                                        ...
                                                        data-target="#largeModal" 
                                                        title="Ban" 
                                                        id="<?php echo $row['blog_id']; ?>"><i class="fa fa-times"></i></button>
                                                </li>
                                                <li class="list-inline-item">
                                                    <button 
                                                        ...
                                                        data-target="#largeModal" 
                                                        title="Delete" 
                                                        id="<?php echo $row['blog_id']; ?>"><i class="fa fa-trash"></i></button>
                                                </li>
                                            </ul>
                                            </td>
                                        </tr>
