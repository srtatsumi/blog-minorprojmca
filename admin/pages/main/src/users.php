...
<body class="theme-blue">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2020 - 2021 <a href="javascript:void(0);"></a>.
                </div>
            </div>
            <!-- #Footer -->
        </aside>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $obj=new Config;
                                            $sql=$obj->conn()->query("SELECT * FROM users WHERE (is_banned='0' OR is_banned IS NULL) AND (is_deleted='0' OR is_deleted IS NULL) ");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    $obj1=new Config;
                                                    $sql1=$obj1->conn()->query("SELECT * FROM blog WHERE blog_by='$row[user_id]' AND is_published='1' ");
                                                    echo $sql1->num_rows;
                                                ?>
                                            <!-- Call to action buttons -->
                                            <ul class="list-inline m-0" style="float: right;margin: -4px;">
                                                <!-- <li class="list-inline-item">
                                                    <button class="btn btn-primary btn-sm rounded-0 ban" type="button" data-toggle="tooltip" title="View"><i class="fa fa-eye"></i></button>
                                                </li> -->
                                                <li class="list-inline-item">
                                                    <button 
                                                        class="btn btn-warning btn-sm rounded-0 ban waves-effect" 
                                                        type="button" 
                                                        data-toggle="modal" 
                                                        data-target="#largeModal" 
                                                        title="Ban" 
                                                        id="<?php echo $row['user_id']; ?>"><i class="fa fa-times"></i>
                                                    </button>
                                                </li>
                                                <li class="list-inline-item">
                                                    <button 
                                                        class="btn btn-danger btn-sm rounded-0 delete waves-effect m-r-20" 
                                                        type="button" 
                                                        data-toggle="modal" 
                                                        data-target="#largeModal" 
                                                        title="Delete" 
                                                        id="<?php echo $row['user_id']; ?>"><i class="fa fa-trash"></i>
                                                    </button>
                                                </li>
                                            </ul>
                                            </td>
