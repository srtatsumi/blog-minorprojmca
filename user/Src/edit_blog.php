...
// $_GET['id']
	...
	$row=$sql->fetch_assoc();
	if($row){
		$_SESSION['edit_blog_id']=$row['blog_id'];
?>
	    ...
	    <div class="sidebar " style="user-select: none;">
			...
			<form class="blog-sidebar" style="text-align: center;margin-top:30%;" enctype="multipart/form-data"method="post">
				<div class="form-group">
					...
					<?php 
						if($row['blog_covpic']){ ?>
							<button name="draft" class="btn btn-primary blue darken-1" style="margin-bottom:10px;margin:25px;" formaction="./redirection/edit_draft.php">Save As Draft</button>
					<?php }else{ ?>
							<button name="draft" class="btn btn-primary blue darken-1" style="margin-bottom:10px;margin:25px;" formaction="./redirection/written_draft.php">Save As Draft</button>
					<?php }
					?>
				 	
					<button name="submit" class="btn btn-primary white" style="margin-bottom:10px;margin:25px;color: Blue" formaction="./redirection/editing-blog.php">Publish</button>
	...
	<div class="col-sm-3">
	    ...
	    <div class="sidebar " style="user-select: none;">
			...
			<form class="blog-sidebar" style="text-align: center;margin-top:30%;" enctype="multipart/form-data"method="post">
				<div class="form-group">
				  	<label for="usr">Add Title</label>
				  	<input type="text" class="form-control" name="title" id="title" style="text-align: center" autocomplete="off">
				  	<br>
				  	<label for="usr">Select Categories</label>
					<select class="browser-default" id="categories" name="category">
						<option value="" disabled selected>Choose your option</option>
						<option value="Backend">Backend</option>
						<option value="Frontend">Frontend</option>
						<option value="Server">Server</option>
					...
					<br>
					<br>
				 	<button name="draft" class="btn btn-primary blue darken-1" style="margin-bottom:10px;margin:25px;" formaction="./redirection/edit-draft.php">Save As Draft</button>
					<button name="submit" class="btn btn-primary white" style="margin-bottom:10px;margin:25px;color: Blue" formaction="./redirection/editing-blog.php">Publish</button>
				</div>
			<!-- </form> -->
		</div>
